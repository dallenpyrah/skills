...
Use host-neutral explorer subagents for the reality check. Spawn both in parallel when the host supports subagents. If not, run both lanes locally and state that parallel subagents were unavailable.
