...
Generated runtime copies live only in global user skill directories:
...
Run `bun sync.ts` from the repo root after editing canonical skills. It deletes and replaces every generated global user skill directory above. It preserves Codex-managed `~/.codex/skills/.system`. Do not hand-edit generated runtime copies.
